            ...
            <div>
              ...
              {showFullDescription ? (
                  ...
                  <div className="relative">
                    {/* Contenedor con altura máxima y overflow oculto */}
                    <div className="max-h-24 overflow-hidden">
                      <p className="text-gray-700 leading-relaxed whitespace-pre-line break-words">
                        {application.jobPosting.description || 'No hay descripción disponible para este puesto.'}
                      </p>
                    </div>
                    {/* Overlay con gradiente y botón "Ver más" */}
                    <div className="absolute bottom-0 left-0 w-full h-12 bg-gradient-to-t from-white to-transparent flex items-end">
                      <button

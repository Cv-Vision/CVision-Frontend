...
import { XMarkIcon, QuestionMarkCircleIcon, DocumentTextIcon, ChevronLeftIcon } from '@heroicons/react/24/outline';
        ...
        <div className="bg-gradient-to-r from-blue-500 to-indigo-600 text-white p-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              {/* Botón de volver solo visible en la segunda pestaña */}
    ...
    <div className="p-6">
      ...
      <div className="space-y-6 mb-8">
        {questions.map((question, index) => {
          ...
          return (
            <div key={question.id} className="border border-gray-200 rounded-xl p-6 hover:border-blue-300 transition-colors">
              <div className="mb-4">
